#Rpi Motion and 1 Wire basic config

##Basic setup for Rpi with Motion and a DS18B20 temperature sensor
...
picture_filename %Y/%b/%Y%m%d%H%M%S-%q
...
20,50 * * * * rsync -avz -e ssh /home/pi/supraveghere/ LinuxServer:/var/www/.../Picture/
